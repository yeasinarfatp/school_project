...
require 'dashboard_part/header.php';
 ?>
       ...
       <div class="col-lg-12 m-auto p-3 mb-2 p-3 mb-2 bg-info text-white">
         ...
         <form action="welcome_post.php" method="post" enctype="multipart/form-data" class="bg-light">
           <div class="row">
             <div class="col-lg-12 pt-2">
               
                <label for="" class="text-dark m-2">Title</label>
           <input type="text" name="title" class="form-control" placeholder="Welcome title">

             </div>

             <div class="col-lg-12 pt-2 ">
               <label for="" class="text-dark m-2">Description</label>
